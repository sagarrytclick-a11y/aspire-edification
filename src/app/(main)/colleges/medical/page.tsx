    ...
    <div className="min-h-screen bg-white text-[#1E293B]">
      ...
      <section className="pt-24 pb-12 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Top <span className="text-[#10B981]">Medical</span> Colleges
          </h1>
          <p className="text-[#64748B] max-w-2xl mx-auto text-base mb-10">
            Premier medical colleges offering MBBS, BDS, and specialized healthcare programs.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <CollegeMapping
          ...
          onRefetch={refetch}
          emptyMessage="No matching medical colleges found"
        />
      </section>
    </div>
  )
