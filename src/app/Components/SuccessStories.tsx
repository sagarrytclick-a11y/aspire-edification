  ...
  const stories = [
    {
      ...
      story: "From a small town in India to MIT - Aspire Edification made my dream come true with personalized guidance and scholarship support.",
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80", 
      story: "Aspire Edification helped me choose the right program and secured a 75% scholarship. Now working at top tech company.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 font-semibold text-lg max-w-3xl mx-auto">
            Real stories from real students who transformed their dreams into reality with Aspire Edification.
          </p>
        </div>
